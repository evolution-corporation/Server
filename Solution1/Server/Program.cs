...
// add services to DI container
{
    ...
    var xyu = builder.Configuration.GetSection("Resources");
    var resources = new Resources{MeditationAudio = xyu["MeditationAudio"],MeditationImages = xyu["MeditationImages"],UserImage = xyu["UserImage"]};
    services.AddSingleton(_ => resources);
    //services.Configure<Resources>(_ => resources);
